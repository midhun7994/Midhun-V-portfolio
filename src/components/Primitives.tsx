...
export const SectionEyebrow: React.FC<SectionEyebrowProps> = ({ label, tag }) => (
  <div className="inline-flex items-center gap-2">
    ...
    <span className="text-xs uppercase tracking-wider text-white/70 font-semibold">{label}</span>
    {tag && (
      <span className="px-2 py-0.5 rounded-full border border-white/10 text-white/50 text-[10px] tracking-normal font-normal">
        {tag}
      </span>
    )}
  </div>
