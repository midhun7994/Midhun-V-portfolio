  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20 md:py-32 relative z-10">
      <motion.div
        ...
        className="liquid-glass relative overflow-hidden rounded-3xl px-8 py-16 md:py-24 text-center border border-white/10 flex flex-col items-center"
      >
        {/* Radial Glow Overlay */}
        <div
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 relative z-10">
          ...
          <button className="rounded-full border border-white/15 text-white text-sm font-medium px-5 py-3 hover:bg-white/5 inline-flex items-center gap-2 transition-colors">
